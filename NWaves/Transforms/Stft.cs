...
namespace NWaves.Transforms
{
    ...
    ///// <summary>
    ///// STFT class based on complex FFT (for comparison: 25-30% slower).
    ///// </summary>
    //public class StftC
    //{
    //    /// <summary>
    ...
    //    /// <param name="window">Type of the window function to apply</param>
    //    /// <param name="fftSize">Size of FFT</param>
    //    public StftC(int windowSize = 1024, int hopSize = 256, WindowTypes window = WindowTypes.Hann, int fftSize = 0)
    //    {
    //        _fftSize = fftSize >= windowSize ? fftSize : MathUtils.NextPowerOfTwo(windowSize);
    ...
    //            if (_window != WindowTypes.Rectangular)
    //            {
    //                stft[i].Item1.ApplyWindow(_windowSamples);
    //            }
